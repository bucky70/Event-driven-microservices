...
public class TwitterKafkaConsumer implements KafkaConsumer<Long, TwitterAvroModel> {
    ...
    public TwitterKafkaConsumer(KafkaListenerEndpointRegistry listenerEndpointRegistry,
                                ...
                                KafkaConfigData configData, AvroToElasticModelTransformer avroToElasticModelTransformer, KafkaConsumerConfigData kafkaConsumerConfigData, ElasticIndexClient elasticIndexClient) {
    ...
    @EventListener
    public void onApptarted(ApplicationStartedEvent event){
       kafkaAdminClient.checkTopicsCreated();
        LOG.info("topics with name {} is ready for operation", kafkaConfigData.getTopicNameToCreate().toArray());
